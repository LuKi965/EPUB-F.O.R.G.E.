...
CATALOGUE: dict[str, str] = {
    ...
    "css.malformed-declaration-converter-kept": "{count} declaration(s) written the way an HTML attribute is written bear a converter's signature; this mode keeps what it finds, so they stay — no reading system has ever applied them, and strict removes them",
...
CATALOGUE_PL: dict[str, str] = {
    ...
    'css.malformed-declaration-converter-kept': '{count} {count:deklaracja zapisana|deklaracje zapisane|deklaracji zapisanych} tak, jak zapisuje się atrybut HTML, {count:nosi|noszą|nosi} podpis konwertera; ten tryb zachowuje to, co zastał, więc {count:zostaje|zostają|zostaje} — żaden czytnik nigdy ich nie zastosował, a tryb ścisły je usuwa',
