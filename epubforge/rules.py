...
CATALOGUE: dict[str, str] = {
    ...
    "css.style-typo-kept": "{count} unreachable rule(s) here name something one edit away from a name the book uses ({examples}); left for a person to judge",
...
CATALOGUE_PL: dict[str, str] = {
    ...
    'css.style-typo-kept': '{count} {count:nieosiągalna reguła nazywa|nieosiągalne reguły nazywają|nieosiągalnych reguł nazywa} coś o jeden znak od nazwy używanej w książce ({examples}); zostawione do osądu człowieka',
