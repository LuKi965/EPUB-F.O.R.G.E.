...
CATALOGUE: dict[str, str] = {
    ...
    "css.comment-shield-removed": "an HTML-era comment wrapper around the stylesheet was removed; every CSS parser since 1997 was already ignoring it",
...
CATALOGUE_PL: dict[str, str] = {
    ...
    'css.comment-shield-removed': 'zdjęto osłonę komentarza HTML sprzed ery CSS otaczającą arkusz; każdy parser CSS od 1997 roku i tak ją ignorował',
