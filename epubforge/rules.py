...
CATALOGUE_PL: dict[str, str] = {
    ...
    'css.invalid-value-kept': 'zostawiono {count} {count:deklarację|deklaracje|deklaracji} z niepoprawną wartością „regular” na Twoją odpowiedź: ten arkusz ustawia też kursywę albo pogrubienie, a „normal” nadpisałoby to, co te elementy dziedziczą',
    ...
    'xhtml.document-language-aligned': 'dokument mówił, że jest napisany w {was}, a publikacja mówi {now}; na Twoją odpowiedź dokument też mówi teraz {now} — ma {count} {count:znak|znaki|znaków}, za mało, żeby same były dowodem języka',
