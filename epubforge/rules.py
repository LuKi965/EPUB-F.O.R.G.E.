...
CATALOGUE: dict[str, str] = {
    ...
    "paragraphs.empty-runs-removed": "{count} empty paragraph(s) removed from {documents} document(s), on a person's word or a batch's standing answer: runs of two or more between paragraphs are down to one blank line, runs at a document edge or beside a heading are gone; the text is the same to the character, {breaks} single break(s) between scenes untouched, and the change ledger carries the entry",
...
CATALOGUE_PL: dict[str, str] = {
    ...
    'paragraphs.empty-runs-removed': '{count} {count:pusty akapit|puste akapity|pustych akapitów} usuniętych z {documents} {documents:dokumentu|dokumentów|dokumentów}, na słowo człowieka albo stałą odpowiedź partii: ciągi dwóch i więcej między akapitami zeszły do jednej pustej linii, ciągi na brzegu dokumentu i przy nagłówku zniknęły; tekst jest ten sam co do znaku, {breaks} {breaks:pojedyncza przerwa|pojedyncze przerwy|pojedynczych przerw} między scenami nietknięte, a wpis jest w bilansie zmian',
