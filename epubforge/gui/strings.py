...
PL: dict[str, str] = {
    ...
    "policy.style-sweep.tip": (
        ...
        "kix…) i bloki powtórzone żywcem w wielu rozdziałach — w rozdziałach "
        "i w osobnych plikach arkuszy. Reszta zostaje i jest tylko policzona "
        "w raporcie; martwa reguła i tak niczego nie rysuje, więc wygląd "
        "książki się nie zmienia.\n\n"
    ...
    # --- new shell (2026 revamp) ----------------------------------------
    "shell.nav.home": "Start",
    "shell.nav.rebuild": "Przebudowa",
    "shell.nav.tools": "Narzędzia",
    "shell.nav.history": "Historia",
    "shell.nav.settings": "Ustawienia",
    "shell.tagline": "Lepsze e-booki.\nNa Twoich zasadach.",

    "shell.step.files": "Pliki",
    "shell.step.analysis": "Analiza",
    "shell.step.plan": "Plan przebudowy",
    "shell.step.results": "Wyniki",
    "shell.step.done": "zrobione",
    "shell.step.current": "w toku",
    "shell.step.todo": "do wykonania",
    "shell.step.reader": "krok {index} z {total}: {name}, {state}",

    "shell.status.queued": "w kolejce",
    "shell.status.analysing": "analizuję",
    "shell.status.ready": "gotowa",
    "shell.status.running": "w trakcie",
    "shell.status.done": "gotowe",
    "shell.status.attention": "wymaga uwagi",
    "shell.status.blocked": "odmowa",
    "shell.status.failed": "niepowodzenie",
    "shell.status.cancelled": "przerwane",

    "shell.safety.title": "Oryginały pozostaną nietknięte",
    "shell.safety.body": "Program tworzy nowe pliki; żaden plik źródłowy nie jest nadpisywany ani kasowany.",
    "shell.local.title": "Pliki są przetwarzane lokalnie",
    "shell.local.body": (
        "Twoje książki nie opuszczają tego komputera. Zawsze powstaje nowa, "
        "przebudowana kopia, a oryginał zostaje na miejscu."
    ),

    "shell.home.eyebrow": "Witamy w EPUB F.O.R.G.E.",
    "shell.home.title": "Co chcesz zrobić?",
    "shell.home.subtitle": "Naprawiaj, porządkuj i analizuj swoje e-booki.",
    "shell.home.aside": "Prosto, bezpiecznie, lokalnie.",
    "shell.home.library.title": "Przeanalizuj bibliotekę",
    "shell.home.library.body": "Sprawdź całą kolekcję i zobacz, które problemy powtarzają się najczęściej.",
    "shell.home.diagnostics.title": "Sprawdź plik",
    "shell.home.diagnostics.body": "Szybka diagnoza jednego pliku EPUB lub PDF, bez zmieniania czegokolwiek.",
    "shell.home.open": "Otwórz narzędzie",
    "shell.home.recent": "Ostatnie zadania",
    "shell.home.recent.body": "Wróć do raportu albo powtórz przebudowę.",
    ...
    "shell.rebuild.title.analysis": "Analizuję książki",
    "shell.rebuild.title.plan": "Przygotuj przebudowę",
    "shell.rebuild.title.running": "Przebudowuję książki",
    "shell.rebuild.title.results": "Przebudowa zakończona",
    "shell.rebuild.subtitle.files": "Dodaj pliki, a program sprawdzi je przed jakąkolwiek zmianą.",
    "shell.rebuild.subtitle.analysis": "Sprawdzam strukturę, zgodność i to, co wymaga decyzji.",
    "shell.rebuild.subtitle.plan": "Sprawdź analizę, wybierz plan i rozpocznij. Oryginały pozostaną bez zmian.",
    "shell.rebuild.subtitle.running": "Tworzę nowe pliki. Oryginały pozostają bez zmian.",
    "shell.rebuild.subtitle.results": "{count} {count:książkę|książki|książek} zapisano. Oryginały pozostały bez zmian.",

    "shell.files.add": "Dodaj kolejne",
    "shell.files.clear": "Wyczyść listę",
    ...
    "shell.plan.nothing.note": "Nie ma czego przebudować — zaznacz co najmniej jedną książkę, którą da się przebudować.",
    "shell.plan.count": "{count} {count:książka gotowa|książki gotowe|książek gotowych} do przebudowy",
    "shell.plan.subtitle": "Odznacz to, czego nie chcesz przebudowywać w tym przebiegu.",
    "shell.plan.include": "Weź „{title}” do przebudowy",
    "shell.plan.unavailable": "Tego pliku nie da się przebudować — powód obok",
    "shell.plan.remove": "Usuń „{title}” z listy",
    "shell.plan.destination": "Miejsce docelowe",
    "shell.plan.destination.beside": "Obok oryginałów",
    "shell.plan.destination.choose": "Wybierz folder…",
    "shell.plan.destination.tip": (
        "Gdy nie wskażesz folderu, każda książka trafia obok oryginału z końcówką "
        "„.forged.epub”. Oryginał nigdy nie jest nadpisywany."
    ),
    "shell.plan.title": "Plan przebudowy",
    "shell.plan.body": "Wybierz, jak chcesz przebudować książki. Szczegóły zawsze możesz dostosować.",
    "shell.plan.details": "Dostosuj szczegóły",
    "shell.plan.changed": "{count} {count:zmienione ustawienie|zmienione ustawienia|zmienionych ustawień}",

    "shell.preset.recommended": "Zalecane",
    "shell.preset.preserve": "Zachowaj wygląd",
    "shell.preset.preserve.body": "Napraw wykryte problemy, zachowując oryginalny układ i wygląd.",
    "shell.preset.strict": "Maksymalna zgodność",
    "shell.preset.strict.body": "Dostosuj książkę do najnowszego standardu. Wygląd może się nieznacznie zmienić.",
    "shell.preset.container": "Tylko naprawa kontenera",
    "shell.preset.container.body": "Napraw strukturę pliku bez zmian w treści i wyglądzie.",
    "shell.preset.risky": "Ten plan włącza ustawienia, które mogą usunąć zasoby — zobacz szczegóły.",

    "shell.summary.title": "Podsumowanie",
    "shell.summary.body": "Sprawdź ustawienia przed rozpoczęciem.",
    "shell.summary.files": "Pliki",
    "shell.summary.mode": "Tryb",
    "shell.summary.epubcheck": "EPUBCheck",
    "shell.summary.destination": "Miejsce docelowe",
    "shell.summary.on": "Włączony",
    "shell.summary.off": "Wyłączony",
    "shell.run": "Rozpocznij przebudowę",
    "shell.run.tip": "Tworzy nowe pliki. Nic w plikach źródłowych się nie zmieni.",
    ...
    "shell.overwrite.body": (
        "Plik „{name}” zapisałby się dokładnie tam, skąd pochodzi. Wskaż inny "
        "folder docelowy — oryginał nie zostanie ruszony."
    ),

    "shell.results.banner.ok": "Przebudowa zakończona pomyślnie",
    "shell.results.banner.ok.body": "Wszystkie książki zostały zapisane. Oryginały pozostały bez zmian.",
    "shell.results.banner.warn": "Zakończone, część książek wymaga uwagi",
    "shell.results.banner.warn.body": "Pliki powstały; zajrzyj do pozycji oznaczonych ostrzeżeniem.",
    "shell.results.banner.failed": "Część książek nie została zapisana",
    ...
    "shell.results.list": "Wyniki",
    "shell.results.list.body": "Kliknij książkę, aby zobaczyć szczegóły zmian.",
    "shell.results.fixed": "napraw",
    "shell.results.fixed.reader": "{count} {count:naprawa|naprawy|napraw}",
    "shell.results.open": "Pokaż szczegóły: {title}",
    "shell.results.changes": "Co zmieniono",
    "shell.results.changes.body": "Najważniejsze kategorie zmian w wybranej książce.",
    "shell.results.report": "Pokaż pełny raport techniczny",
    "shell.results.report.body": "Dla zaawansowanych użytkowników.",
    "shell.results.report.title": "Raport techniczny — {title}",
    ...
    "shell.changes.validation": "Walidacja EPUBCheck",
    "shell.changes.structure": "Struktura i pliki",
    "shell.changes.text": "Tekst i znaki",
    "shell.changes.metadata": "Metadane",
    "shell.changes.kept": "Zachowane świadomie",
    "shell.changes.none": "Bez zmian w tej kategorii.",

    "shell.drawer.title": "Dostosuj plan",
    "shell.drawer.subtitle": "Zmieniasz ustawienia dla {count} {count:książki|książek|książek}",
    "shell.drawer.category": "Kategoria ustawień",
    "shell.drawer.search": "Szukaj ustawienia",
    "shell.drawer.reset": "Przywróć ustawienia zalecane",
    "shell.drawer.expert": "Pokaż opcje eksperckie",
    "shell.drawer.expert.hide": "Ukryj opcje eksperckie",
    "shell.drawer.apply": "Zastosuj zmiany",
    "shell.drawer.cancel": "Anuluj",
    "shell.drawer.close": "Zamknij szufladę",
    "shell.drawer.risky": "Ryzykowne",
    "shell.drawer.changed": "{count} {count:zmienione ustawienie|zmienione ustawienia|zmienionych ustawień}",
    "shell.drawer.none": "Nic nie pasuje do „{text}”.",
    "shell.drawer.footer": "Ustawienia bezpieczne są włączone domyślnie.",

    "shell.cat.basics": "Podstawowe",
    "shell.cat.basics.body": "Najważniejsze decyzje wpływające na efekt przebudowy.",
    "shell.cat.compat": "Zgodność",
    "shell.cat.compat.body": "Ustępstwa na rzecz konkretnych czytników i starszych urządzeń.",
    "shell.cat.look": "Wygląd i typografia",
    "shell.cat.look.body": "Co wolno zmienić w składzie i stylach książki.",
    "shell.cat.words": "Tekst i pytania",
    "shell.cat.words.body": "Co program robi z samym tekstem i o co pyta po drodze.",
    "shell.cat.assets": "Pliki i zasoby",
    "shell.cat.assets.body": "Fonty, obrazy i to, co sklep dołożył do książki.",
    "shell.cat.metadata": "Metadane",
    ...
    "pdf.analysis.checked": "{pages} {pages:strona|strony|stron}; {text}; {links} {links:odsyłacz|odsyłacze|odsyłaczy}; {renderer}",
    "pdf.analysis.layout": "próbka: {columns} {columns:strona|strony|stron} w kolumnach, {drawings} {drawings:rysunek|rysunki|rysunków}, {tables} {tables:tabela|tabele|tabel}, pagina na {heads} z {sampled} {sampled:strony|stron|stron}",
    "pdf.candidates": "Co konwersja zastanie:",
    "pdf.candidate.heads": "Żywa pagina na {pages} z {sampled} {sampled:strony|stron|stron} próbki — konwersja zapyta, czy ją usunąć.",
    "pdf.candidate.drawings": "{count} {count:rysunek wektorowy|rysunki wektorowe|rysunków wektorowych} na próbce — zostaną przeniesione jako obrazy.",
    "pdf.candidate.drawings.no-renderer": "{count} {count:rysunek wektorowy|rysunki wektorowe|rysunków wektorowych} na próbce — bez renderera zostaną z nich tylko napisy.",
    "pdf.candidate.columns": "Kolumny na {pages} z {sampled} {sampled:strony|stron|stron} próbki — czytane po obszarach.",
    "pdf.candidate.tables": "{count} {count:tabela|tabele|tabel} na próbce — odtwarzane jako tabele.",
    "pdf.analysis.text.yes": "warstwa tekstowa jest (próbka {sampled} {sampled:strony|stron|stron})",
    "pdf.analysis.text.no": "brak warstwy tekstowej",
    "pdf.analysis.renderer.yes": "renderer rysunków jest",
    "pdf.analysis.renderer.no": "brak renderera rysunków",
    "pdf.analysis.encrypted": "Dokument jest zaszyfrowany — program nie czyta zaszyfrowanych PDF-ów.",
    "pdf.analysis.no-text": "Próbka stron nie ma warstwy tekstowej — to skan, a program nie robi OCR.",
    "pdf.analysis.unreadable": "Nie udało się odczytać pliku jako PDF: {detail}",
    "pdf.analysis.not-a-file": "Nie udało się otworzyć pliku: {detail}",
    ...
    "pdf.plan.count": "{count} {count:dokument gotowy|dokumenty gotowe|dokumentów gotowych} do konwersji",
    "pdf.step.documents": "Dokumenty",
    "pdf.step.settings": "Ustawienia",
    "pdf.step.reading": "Wczytanie",
    ...
    "shell.tools.subtitle": "Funkcje specjalistyczne — dostępne, ale nieprzeszkadzające w zwykłej pracy.",
    "shell.tools.library.title": "Biblioteka",
    "shell.tools.library.body": "Zbadaj całą kolekcję i zobacz, które problemy występują najczęściej.",
    "shell.tools.diagnostics.title": "Diagnostyka pliku",
    "shell.tools.diagnostics.body": "Struktura, EPUBCheck, kompletność, zdrowie archiwum i zgodność wizualna.",
    "shell.tools.corpus.title": "Korpus regresji",
    "shell.tools.corpus.body": "Porównaj podpisy książek po zmianach w silniku.",
    "shell.tools.corpus.badge": "Eksperckie",
    "shell.tools.merge.title": "Scal kopie",
    "shell.tools.merge.body": "Jedna dobra książka z dwóch uszkodzonych w różnych miejscach.",
    "shell.tools.open": "Otwórz",
    "shell.tool.result": "Wynik",
    "shell.tool.copy": "Kopiuj",
    "shell.tool.copy.tip": "Kopiuje cały wynik do schowka.",
    "shell.tool.copied": "Skopiowano do schowka.",
    "shell.tool.working": "Pracuję…",
    "shell.tool.source.placeholder": "Wskaż folder",
    "shell.tool.source.file": "Wskaż plik EPUB albo folder z książkami",
    "shell.tools.back": "Wróć do narzędzi",

    "shell.history.eyebrow": "Historia",
    "shell.history.title": "Poprzednie zadania",
    ...
    "shell.history.forget.tip": "Usuwa listę zadań. Nie kasuje żadnego pliku ani raportu.",

    "shell.settings.eyebrow": "Ustawienia",
    "shell.settings.title": "Preferencje aplikacji",
    "shell.settings.subtitle": "Ustawienia globalne — nie zastępują planu konkretnej przebudowy.",
    "shell.settings.general": "Ogólne",
    "shell.settings.language": "Język interfejsu",
    "shell.settings.language.body": "Zmiana języka przebudowuje okno; kolejka pozostaje.",
    "shell.settings.theme": "Motyw",
    "shell.settings.theme.body": "Jasny, ciemny albo taki, jaki ustawiono w systemie.",
    "shell.settings.theme.system": "Jak w systemie",
    "shell.settings.theme.light": "Jasny",
    "shell.settings.theme.dark": "Ciemny",
    "shell.settings.remember": "Zapamiętuj ostatni folder",
    "shell.settings.remember.body": "Przy kolejnym wyborze plików zacznij od ostatniej lokalizacji.",
    "shell.settings.about": "O programie",
    "shell.settings.about.body": "Wersja, licencje i dołączone komponenty.",
    "shell.settings.about.open": "Pokaż",
    "shell.settings.restart": "Zmiana zacznie obowiązywać po ponownym otwarciu okna.",

    "shell.analysis.summary": "EPUB {version} · {resources} {resources:plik|pliki|plików} · {spine} w kolejności czytania",
    "shell.analysis.pdf": "PDF — przy przebudowie zostanie odczytana warstwa tekstowa.",
    "shell.analysis.drm": "Plik jest zabezpieczony DRM — tego programu to nie dotyczy i nic z nim nie zrobi.",
    "shell.analysis.unreadable": "Nie da się odczytać: {reason}",
    "shell.analysis.failed": "Analiza nie powiodła się",
    "shell.error.kept": "Twoja lista, preset, folder docelowy i zmienione ustawienia zostały zachowane.",
    "shell.error.retry": "Spróbuj ponownie",
    "shell.error.back": "Wróć do planu",
    "shell.error.drop": "Usuń problematyczne pliki",
    "shell.error.drop.tip": "Wyrzuca z partii pliki, których nie da się przebudować, i zostawia resztę.",
    "shell.results.selected": "Wybrana książka",
    "shell.error.title": "Coś poszło nie tak",
    "shell.error.body": "{error}",
    "policy.watermark": "Znaki wodne sklepu",
    "policy.memory.limit": "Limit pamięci",
    "policy.time.budget": "Limit czasu na książkę",
    "policy.content.dir": "Katalog treści w archiwum",
    "policy.content.dir.tip": (
        "Nazwa folderu, w którym w gotowym pliku leży pakiet i treść. Zmiana jest "
        "narzędziem diagnostycznym — służy do odtworzenia układu, jakiego oczekuje "
        "konkretny czytnik, a nie decyzją o książce."
    ),
    "policy.content.dir.placeholder": "EPUB",
    "policy.package.name": "Nazwa pliku pakietu",
    "policy.package.name.tip": (
        "Nazwa pliku OPF wewnątrz archiwum. Jak wyżej: diagnostyka, nie wybór "
        "dotyczący treści."
    ),
    "policy.package.name.placeholder": "package.opf",
}
...
EN: dict[str, str] = {
    ...
    "policy.style-sweep.tip": (
        ...
        "repeated verbatim across chapters are removed — in chapters and in "
        "separate stylesheet files alike. Everything else stays and is only "
        "counted; a dead rule draws nothing anyway, so the book's look does "
        "not change.\n\n"
    ...
    "policy.class-names.tip": (
        ...
        "simple rule gets a speaking one, e.g. ef-italic. When the "
        "generator's own name carries a role (sgc-toc-title is Sigil's "
        "record of a table of contents), the role is translated: "
        "ef-contents, ef-contents-2 — the digit is the source's level, "
        "not an order.\n\n"
    ...
    # --- new shell (2026 revamp) ----------------------------------------
    "shell.nav.home": "Start",
    "shell.nav.rebuild": "Rebuild",
    "shell.nav.tools": "Tools",
    "shell.nav.history": "History",
    "shell.nav.settings": "Settings",
    "shell.tagline": "Better e-books.\nOn your terms.",

    "shell.step.files": "Files",
    "shell.step.analysis": "Analysis",
    "shell.step.plan": "Rebuild plan",
    "shell.step.results": "Results",
    "shell.step.done": "done",
    "shell.step.current": "in progress",
    "shell.step.todo": "to do",
    "shell.step.reader": "step {index} of {total}: {name}, {state}",

    "shell.status.queued": "queued",
    "shell.status.analysing": "analysing",
    "shell.status.ready": "ready",
    "shell.status.running": "running",
    "shell.status.done": "done",
    "shell.status.attention": "needs a look",
    "shell.status.blocked": "refused",
    "shell.status.failed": "failed",
    "shell.status.cancelled": "cancelled",

    "shell.safety.title": "Your originals stay untouched",
    "shell.safety.body": "New files are written; no source file is overwritten or deleted.",
    "shell.local.title": "Files are processed locally",
    "shell.local.body": (
        "Your books never leave this computer. A new, rebuilt copy is always "
        "created and the original stays where it is."
    ),

    "shell.home.eyebrow": "Welcome to EPUB F.O.R.G.E.",
    "shell.home.title": "What would you like to do?",
    "shell.home.subtitle": "Repair, tidy and analyse your e-books.",
    "shell.home.aside": "Simple, safe, local.",
    "shell.home.library.title": "Analyse a library",
    "shell.home.library.body": "Survey a whole collection and see which problems recur.",
    "shell.home.diagnostics.title": "Inspect a file",
    "shell.home.diagnostics.body": "A quick diagnosis of one EPUB or PDF, changing nothing.",
    "shell.home.open": "Open tool",
    "shell.home.recent": "Recent jobs",
    "shell.home.recent.body": "Go back to a report or rebuild again.",
    ...
    "shell.rebuild.title.analysis": "Analysing books",
    "shell.rebuild.title.plan": "Prepare the rebuild",
    "shell.rebuild.title.running": "Rebuilding books",
    "shell.rebuild.title.results": "Rebuild finished",
    "shell.rebuild.subtitle.files": "Add files; they are examined before anything changes.",
    "shell.rebuild.subtitle.analysis": "Reading structure, conformance and anything needing a decision.",
    "shell.rebuild.subtitle.plan": "Check the analysis, choose a plan and start. Originals stay unchanged.",
    "shell.rebuild.subtitle.running": "Writing new files. Originals stay unchanged.",
    "shell.rebuild.subtitle.results": "{count} book(s) written. Your originals are unchanged.",

    "shell.files.add": "Add more",
    "shell.files.clear": "Clear list",
    ...
    "shell.plan.nothing.note": "Nothing to rebuild — tick at least one book that can be rebuilt.",
    "shell.plan.count": "{count} book(s) ready to rebuild",
    "shell.plan.subtitle": "Untick anything you do not want rebuilt in this run.",
    "shell.plan.include": "Include “{title}” in the rebuild",
    "shell.plan.unavailable": "This file cannot be rebuilt — the reason is beside it",
    "shell.plan.remove": "Remove “{title}” from the list",
    "shell.plan.destination": "Destination",
    "shell.plan.destination.beside": "Next to the originals",
    "shell.plan.destination.choose": "Choose a folder…",
    "shell.plan.destination.tip": (
        "With no folder chosen, each book is written next to its original with a "
        "“.forged.epub” suffix. The original is never overwritten."
    ),
    "shell.plan.title": "Rebuild plan",
    "shell.plan.body": "Choose how the books should be rebuilt. You can always adjust the details.",
    "shell.plan.details": "Adjust details",
    "shell.plan.changed": "{count} changed setting(s)",

    "shell.preset.recommended": "Recommended",
    "shell.preset.preserve": "Preserve appearance",
    "shell.preset.preserve.body": "Repair what is broken while keeping the original layout and look.",
    "shell.preset.strict": "Maximum conformance",
    "shell.preset.strict.body": "Bring the book to the current standard. The look may change slightly.",
    "shell.preset.container": "Container repair only",
    "shell.preset.container.body": "Repair the file structure without touching content or appearance.",
    "shell.preset.risky": "This plan enables settings that can remove resources — see the details.",

    "shell.summary.title": "Summary",
    "shell.summary.body": "Check the settings before starting.",
    "shell.summary.files": "Files",
    "shell.summary.mode": "Mode",
    "shell.summary.epubcheck": "EPUBCheck",
    "shell.summary.destination": "Destination",
    "shell.summary.on": "On",
    "shell.summary.off": "Off",
    "shell.run": "Start the rebuild",
    "shell.run.tip": "Writes new files. Nothing in the source files changes.",
    ...
    "shell.overwrite.body": (
        "“{name}” would be written exactly where it came from. Choose another "
        "destination folder — the original will not be touched."
    ),

    "shell.results.banner.ok": "Rebuild finished successfully",
    "shell.results.banner.ok.body": "Every book was written. Your originals are unchanged.",
    "shell.results.banner.warn": "Finished; some books need a look",
    "shell.results.banner.warn.body": "The files exist; check the rows marked with a warning.",
    "shell.results.banner.failed": "Some books were not written",
    ...
    "shell.results.list": "Results",
    "shell.results.list.body": "Click a book to see what changed in it.",
    "shell.results.fixed": "repairs",
    "shell.results.fixed.reader": "{count} repair(s)",
    "shell.results.open": "Show details: {title}",
    "shell.results.changes": "What changed",
    "shell.results.changes.body": "The main categories of change in the selected book.",
    "shell.results.report": "Show the full technical report",
    "shell.results.report.body": "For advanced users.",
    "shell.results.report.title": "Technical report — {title}",
    ...
    "shell.changes.validation": "EPUBCheck validation",
    "shell.changes.structure": "Structure and files",
    "shell.changes.text": "Text and characters",
    "shell.changes.metadata": "Metadata",
    "shell.changes.kept": "Kept on purpose",
    "shell.changes.none": "Nothing changed in this category.",

    "shell.drawer.title": "Adjust the plan",
    "shell.drawer.subtitle": "You are changing settings for {count} book(s)",
    "shell.drawer.category": "Setting category",
    "shell.drawer.search": "Search settings",
    "shell.drawer.reset": "Restore recommended settings",
    "shell.drawer.expert": "Show expert options",
    "shell.drawer.expert.hide": "Hide expert options",
    "shell.drawer.apply": "Apply changes",
    "shell.drawer.cancel": "Cancel",
    "shell.drawer.close": "Close the drawer",
    "shell.drawer.risky": "Risky",
    "shell.drawer.changed": "{count} changed setting(s)",
    "shell.drawer.none": "Nothing matches “{text}”.",
    "shell.drawer.footer": "The safe settings are on by default.",

    "shell.cat.basics": "Basics",
    "shell.cat.basics.body": "The decisions that shape what a rebuild produces.",
    "shell.cat.compat": "Compatibility",
    "shell.cat.compat.body": "Concessions to particular readers and older devices.",
    "shell.cat.look": "Look and typography",
    "shell.cat.look.body": "What may be changed in the book's layout and styles.",
    "shell.cat.words": "Text and questions",
    "shell.cat.words.body": "What happens to the words themselves, and what you are asked along the way.",
    "shell.cat.assets": "Files and resources",
    "shell.cat.assets.body": "Fonts, images and whatever the shop added to the book.",
    "shell.cat.metadata": "Metadata",
    ...
    "pdf.analysis.checked": "{pages} page(s); {text}; {links} link(s); {renderer}",
    "pdf.analysis.layout": "sample: {columns} page(s) in columns, {drawings} drawing(s), {tables} table(s), running heads on {heads} of {sampled} page(s)",
    "pdf.candidates": "What the conversion will meet:",
    "pdf.candidate.heads": "Running heads on {pages} of {sampled} sampled page(s) — the conversion will ask whether to remove them.",
    "pdf.candidate.drawings": "{count} vector drawing(s) in the sample — they will be carried as pictures.",
    "pdf.candidate.drawings.no-renderer": "{count} vector drawing(s) in the sample — without a renderer only their labels survive.",
    "pdf.candidate.columns": "Columns on {pages} of {sampled} sampled page(s) — read by area.",
    "pdf.candidate.tables": "{count} table(s) in the sample — rebuilt as tables.",
    "pdf.analysis.text.yes": "text layer present (sample of {sampled} page(s))",
    "pdf.analysis.text.no": "no text layer",
    "pdf.analysis.renderer.yes": "drawing renderer installed",
    "pdf.analysis.renderer.no": "no drawing renderer",
    "pdf.analysis.encrypted": "The document is encrypted — the program does not read encrypted PDFs.",
    "pdf.analysis.no-text": "The sampled pages carry no text layer — a scan, and the program does no OCR.",
    "pdf.analysis.unreadable": "The file could not be read as a PDF: {detail}",
    "pdf.analysis.not-a-file": "The file could not be opened: {detail}",
    ...
    "pdf.plan.count": "{count} document(s) ready to convert",
    "pdf.step.documents": "Documents",
    "pdf.step.settings": "Settings",
    "pdf.step.reading": "Reading",
    ...
    "shell.tools.subtitle": "Specialist functions — available, but out of the way of ordinary work.",
    "shell.tools.library.title": "Library",
    "shell.tools.library.body": "Survey a whole collection and see which problems are most common.",
    "shell.tools.diagnostics.title": "File diagnostics",
    "shell.tools.diagnostics.body": "Structure, EPUBCheck, completeness, archive health and visual fidelity.",
    "shell.tools.corpus.title": "Regression corpus",
    "shell.tools.corpus.body": "Compare book signatures after a change in the engine.",
    "shell.tools.corpus.badge": "Expert",
    "shell.tools.merge.title": "Merge copies",
    "shell.tools.merge.body": "One good book out of two damaged in different places.",
    "shell.tools.open": "Open",
    "shell.tool.result": "Result",
    "shell.tool.copy": "Copy",
    "shell.tool.copy.tip": "Copies the whole result to the clipboard.",
    "shell.tool.copied": "Copied to the clipboard.",
    "shell.tool.working": "Working…",
    "shell.tool.source.placeholder": "Choose a folder",
    "shell.tool.source.file": "Choose an EPUB file or a folder of books",
    "shell.tools.back": "Back to tools",

    "shell.history.eyebrow": "History",
    "shell.history.title": "Previous jobs",
    ...
    "shell.history.forget.tip": "Empties the list. No file or report is deleted.",

    "shell.settings.eyebrow": "Settings",
    "shell.settings.title": "Application preferences",
    "shell.settings.subtitle": "Global settings — they do not replace the plan of a particular rebuild.",
    "shell.settings.general": "General",
    "shell.settings.language": "Interface language",
    "shell.settings.language.body": "Changing the language rebuilds the window; the queue is kept.",
    "shell.settings.theme": "Theme",
    "shell.settings.theme.body": "Light, dark, or whatever the system is set to.",
    "shell.settings.theme.system": "Follow the system",
    "shell.settings.theme.light": "Light",
    "shell.settings.theme.dark": "Dark",
    "shell.settings.remember": "Remember the last folder",
    "shell.settings.remember.body": "Start the next file chooser where the last one finished.",
    "shell.settings.about": "About",
    "shell.settings.about.body": "Version, licences and bundled components.",
    "shell.settings.about.open": "Show",
    "shell.settings.restart": "The change takes effect when the window is reopened.",

    "shell.analysis.summary": "EPUB {version} · {resources} file(s) · {spine} in reading order",
    "shell.analysis.pdf": "PDF — the text layer is read during the rebuild.",
    "shell.analysis.drm": "This file is DRM-protected; this program does not touch such files.",
    "shell.analysis.unreadable": "Cannot be read: {reason}",
    "shell.analysis.failed": "Analysis failed",
    "shell.error.kept": "Your list, preset, destination folder and changed settings have been kept.",
    "shell.error.retry": "Try again",
    "shell.error.back": "Back to the plan",
    "shell.error.drop": "Remove the problem files",
    "shell.error.drop.tip": "Takes the files that cannot be rebuilt out of the batch and keeps the rest.",
    "shell.results.selected": "Selected book",
    "shell.error.title": "Something went wrong",
    "shell.error.body": "{error}",
    "policy.watermark": "Shop watermarks",
    "policy.memory.limit": "Memory limit",
    "policy.time.budget": "Time budget per book",
    "policy.content.dir": "Content directory in the archive",
    "policy.content.dir.tip": (
        "The folder inside the finished file that holds the package and the "
        "content. Changing it is a diagnostic — a way to reproduce the layout a "
        "particular reader expects — not a decision about the book."
    ),
    "policy.content.dir.placeholder": "EPUB",
    "policy.package.name": "Package file name",
    "policy.package.name.tip": (
        "The name of the OPF file inside the archive. As above: diagnostics, not "
        "a choice about content."
    ),
    "policy.package.name.placeholder": "package.opf",
}
