...
`0.2.3` · alpha · 552 tests · Windows / Linux / macOS
...
- **Alpha.** Two of the three entry conditions written down in
  [`CONTRIBUTING.md`](CONTRIBUTING.md) are unmet: a 30-book corpus green across
  three releases, and a translated report. The third — no known defects that
  lose data silently — has been met since 0.2.2.
- **The report is English-only.** The interface is bilingual; the report is not.
...
552 tests, including three independent safety nets:
